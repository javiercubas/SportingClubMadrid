  ...
  return (
    ...
    <footer className="footer">
      ...
      <div className="footer-content">
        ...
        <div className="footer-content-column">
          <div className="footer-menu">
            <h2 className="footer-menu-name"> Mens</h2>
          ...
          <div className="footer-menu">
            <h2 className="footer-menu-name">Women</h2>
        ...
        <div className="footer-content-column">
          <div className="footer-menu">
            <h2 className="footer-menu-name"> Mens B</h2>
            <ul id="menu-company" className="footer-menu-list">
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
                <a href="#">Roster</a>
              </li>
          ...
          <div className="footer-menu">
            <h2 className="footer-menu-name">Women B</h2>
            <ul id="menu-legal" className="footer-menu-list">
              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy menu-item-170434">
                <a href="#">Roster</a>
              </li>
        ...
        <div className="footer-social-links"> <svg className="footer-social-amoeba-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 236 54">
          ...
          <a className="footer-social-link linkedin" href="https://es.linkedin.com/company/sporting-club-madrid" target="_blank">
          ...
          <a className="footer-social-link instagram" href="https://www.instagram.com/sportingclubmadrid/" target="_blank">
            <span className="hidden-link-text">Twitter</span>
            <i class="fa-brands fa-instagram" style={{fontSize: "xx-large"}}></i>
          </a>
          ...
          <a className="footer-social-link twitter" href="https://mobile.twitter.com/scmadrid2021" target="_blank">
            <span className="hidden-link-text">Twitter</span>
            <svg className="footer-social-icon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
      ...
      <div className="footer-copyright">
        <div className="footer-copyright-wrapper">
          <p className="footer-copyright-text">
            <a className="footer-copyright-link" href="#" target="_self"> ©2020-2022 Sporting Club Madrid. | All rights reserved. </a>
          </p>
        </div>
      </div>
    </footer>
